...
class NodeVM extends VM {
	...
	constructor(options = {}) {
		...
		// Just in case someone is thinkin on using the Symbol and WebAssembly we are going to override it by sending it null values in the sandbox
		this.setGlobals({Symbol: require('./mysimbol'), WebAssembly: null})
	}
