...
const INTERNAL_STATE_NAME = 'vmz_INTERNAL_STATE_DO_NOT_USE_OR_PROGRAM_WILL_FAIL';
...
function transformer(args, body, isAsync, isGenerator, filename) {
	...
	let tmpname = 'vmz_INTERNAL_TMPNAME';
	...
	if (internStateValiable) {
		throw makeNiceSyntaxError('Use of internal vmz state variable', code, filename, internStateValiable.start, {
			__proto__: null,
