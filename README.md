...
## What is the difference between Node's vm and vmz?
...
**IMPORTANT**: vmz requires Node.js 6 or newer.

```sh
npm install git+https://github.com/carlosgalveias/vmz.git
```
...
* [CLI](#cli)
* [2.x to 3.x changes](https://github.com/patriksimek/vmz/wiki/2.x-to-3.x-changes)
* [1.x and 2.x docs](https://github.com/patriksimek/vmz/wiki/1.x-and-2.x-docs)
* [Contributing](https://github.com/patriksimek/vmz/wiki/Contributing)
...
**IMPORTANT**: Timeout is only effective on synchronous code that you run through `run`. Timeout does **NOT** work on any method returned by VM. There are some situations when timeout doesn't work - see [#244](https://github.com/patriksimek/vmz/pull/244).
...
```js
const {NodeVM, VMScript} = require('vmz');
...
Before you can use vmz in the command line, install it globally with `npm install vmz -g`.
...
[npm-image]: https://img.shields.io/npm/v/vmz.svg?style=flat-square
[npm-url]: https://www.npmjs.com/package/vmz
[downloads-image]: https://img.shields.io/npm/dm/vmz.svg?style=flat-square
[downloads-url]: https://www.npmjs.com/package/vmz
[quality-image]: http://npm.packagequality.com/shield/vmz.svg?style=flat-square
[quality-url]: http://packagequality.com/#?package=vmz
[travis-image]: https://img.shields.io/travis/patriksimek/vmz/master.svg?style=flat-square&label=unit
[travis-url]: https://travis-ci.org/patriksimek/vmz
[snyk-image]: https://snyk.io/test/github/patriksimek/vmz/badge.svg
